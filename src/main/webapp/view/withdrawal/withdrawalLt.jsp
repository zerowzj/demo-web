...
<div class="div_head">
            <span>
                <span style="float: left;">当前位置是：账户管理 => 提现申请</span>
...
<div style="font-size: 13px; margin: 10px 5px;">
    <table class="table_a" border="1" width="100%">
        ...
        <c:forEach items="${awEOLt}" var="awEO" varStatus="index">
            <tr>
                <td><c:out value="${awEO.awId}"/></td>
                <td><c:out value="${awEO.awUbId}"/></td>
                <td><c:out value="${awEO.awAmt}"/></td>
                <td><c:out value="${awEO.awStatus}"/></td>
